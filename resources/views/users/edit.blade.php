                ...
                <div class="card-body">
                    <form action="{{ url('/admin/user/update'.$user->id) }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="fullname" id="fullname" required class="form-control" value="{{ $user->fullname }}">
                            @error('fullname')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="phone" id="phone" required class="form-control" value="{{ $user->phone }}">
                            @error('phone')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" name="password" id="password" required class="form-control" value="{{ $user->password }}">
                            @error('password')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
